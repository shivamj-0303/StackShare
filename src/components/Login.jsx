          ...
          <form onSubmit={handleSubmit} className="flex flex-col space-y-5">
            ...
            <div className="flex flex-col space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-xs text-blue-600 hover:underline focus:text-blue-800 font-semibold">
                  Forgot Password?
                </Link>
              </div>
              <input
            ...
            <div className="flex items-center justify-center space-x-3 py-2">
              ...
              <span className="text-xs text-gray-500 font-medium">or login with</span>
              <div className="flex-1 h-px bg-gray-300"></div>
            </div>
            ...
            <div className="flex flex-col space-y-3">
              <a
                href="#"
                className="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border-2 border-gray-800 rounded-md group hover:bg-gray-800 focus:outline-none"
              >
                <svg
                ...
                <span className="text-sm font-semibold text-gray-800 group-hover:text-white">Github</span>
              </a>
              <a
                href="#"
                className="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border-2 border-blue-500 rounded-md group hover:bg-blue-500 focus:outline-none"
              >
                ...
                <span className="text-sm font-semibold text-blue-500 group-hover:text-white">Twitter</span>
              </a>
            </div>
          </form>
        </div>
